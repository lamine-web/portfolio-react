  ...
  return (
    <div className="jumbotron d-flex align-items-center" style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundAttachment: 'fixed', // effet parallax simple
      ...
      <div className="container text-center" style={{ zIndex: 2 }}>
        <motion.h1 className="display-4 fw-bold" initial={{ opacity: 0, y: -40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} >Bienvenue sur mon portfolio
        </motion.h1>

        <motion.p className="lead" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3 }} > Je construis des interfaces modernes et responsives avec passion.
        </motion.p>
